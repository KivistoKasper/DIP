...
// MAGIC * You also find all the relevant Azure resources by going to the [Azure portal](https://portal.azure.com) to Storage accounts and select [`tunics320f2024gen2` /  containers](https://portal.azure.com/#@tuni.onmicrosoft.com/resource/subscriptions/e0c78478-e7f8-429c-a25f-015eae9f54bb/resourceGroups/tuni-cs320-f2024-rg/providers/Microsoft.Storage/storageAccounts/tunics320f2024gen2/containersList).
// MAGIC
...
// MAGIC `abfss://<container>@tunics320f2024gen2.dfs.core.windows.net/<path>/<to>/<file.csv>`
...
// MAGIC file = "abfss://shared@tunics320f2024gen2.dfs.core.windows.net/demo/kaggle/csv/10mb_imdb_anime.csv"
// MAGIC df = spark.read  \
